...
\subsection{Matlab Initialization Code}

\begin{lstlisting}[language=Matlab]
%% LAB1: POSITION S.S. CONTROL
clear all, clc, close all

load ('../param.mat'); % motor nominal parameters
...
%% STATE SPACE CONTROL 
% Nominal tracking: High Pass Filter
w_c = 2*pi*50;
delta_c = 1/sqrt(2);
...
% Extended State Space Controller and gain K_e
A_e = [0 C; zeros(2,1) A];
B_e = [0; B];
C_e = [0 C];
...
% exo-system matrices (generates the signal p that combines dsturbance and reference)
A_p = [0, 1, 0;
       0, 0, 1; 
       0, -w0^2, 0];
C_p = [1, 0, 0];
...
% NOTE: Recommended to use 'place' instead of 'acker' here due to numerical precision
K_ex = place(A_ex', C_ex', lambda_ex); 
L_ex = K_ex';
A_a=A_ex-L_ex*C_ex;
B_a=[B_ex, L_ex];
\end{lstlisting}
